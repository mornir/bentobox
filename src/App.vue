            ...
            <v-container grid-list-xl>
              <v-layout row wrap align-center>
                <v-flex xs12 md4>
                  <v-card class="elevation-0 transparent">
                    <v-card-text class="text-xs-center">
                      <v-icon x-large class="accent--text">color_lens</v-icon>
                    </v-card-text>
                ...
                <v-flex xs12 md4>
                  <v-card class="elevation-0 transparent">
                    <v-card-text class="text-xs-center">
                      <v-icon x-large class="accent--text">flash_on</v-icon>
                    </v-card-text>
                    <v-card-title primary-title class="layout justify-center">
                ...
                <v-flex xs12 md4>
                  <v-card class="elevation-0 transparent">
                    <v-card-text class="text-xs-center">
                      <v-icon x-large class="accent--text">build</v-icon>
                    </v-card-text>
                    <v-card-title primary-title class="layout justify-center">
        ...
        <v-layout row wrap align-center>
          <v-flex xs12>
            <div class="white--text ml-3">
              ...
              and
              <a class="white--text" href="mailto:costa.huang@outlook.com">Costa Huang</a>
            </div>
          </v-flex>
        </v-layout>
      </v-footer>
